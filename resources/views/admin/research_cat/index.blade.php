                ...
                <div class="card-body">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('research-categories.create') }}"
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="row">
                            ...
                            <div class="mb-sm-0">
                                <form action="{{ route('research-categories') }}" method="get">
                                    <div class="row">
                                        <div class="col-lg-4">
                                ...
                                @if($data->count() > 0)
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('research-categories.destroy', $value->id) }}"
                                                    method="POST">
                                                    <a href="{{ route('research-categories.edit', $value->id) }}"
