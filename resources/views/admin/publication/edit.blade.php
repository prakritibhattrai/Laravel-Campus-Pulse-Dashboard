...
@section('content')
    <form action="{{ route('publications.update', $detail->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        {{-- <h4 class="card-title mb-4">Edit Publication</h4> --}}
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="formFileSm" class="form-label">Choose File <small> (ppt, pptx, doc etc) </small></label>
