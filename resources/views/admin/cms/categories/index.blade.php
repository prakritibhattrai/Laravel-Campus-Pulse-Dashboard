                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('categories.create') }}" class="btn btn-primary btn-sm waves-effect waves-light" style="color:white;">
                                Add Categories</a>
                        </li>
                    </ol>
                </div>
                                ...
                                @if($categories->count() > 0)
                                    ...
                                    @foreach($categories as $key=>$category)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-soft-{{$category->status == 'active' ? 'success' : 'danger'}} font-size-11">{{ $category->status}}</span>
                                            </td>

                                            <td>
                                                <form action="{{ route('categories.destroy', $category->id) }}" method="POST">
                                                    <a href="{{route('categories.edit', $category->id)}}" class="btn btn-primary btn-sm waves-effect waves-light">Edit</a>
